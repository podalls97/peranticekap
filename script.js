...
hamburger.addEventListener('click', function (e) {
    ...
    body.classList.toggle('menu-open'); // Prevent body scroll when the menu is open
});

// Close the menu when clicking outside of it
document.addEventListener('click', function (e) {
    // If the click is outside the hamburger or the nav-list, close the menu
...
// Prevent close when clicking inside the nav-list
